...
<head>
    ...
    <title>Driverless - Sign in</title>
            ...
            <form method="POST">
                ...
                // checking the number of failed login attempts
                    if($_SESSION['attempts'] > 2){
                       ...
                       echo '<p id="timer" >Sorry you have been Locked out please wait for <span style="color:red; font-weight:500;" id="locked_minutes">10</span>:<span style="color:red; font-weight:500;" id="locked_seconds">00</span> and try again.</p>';
